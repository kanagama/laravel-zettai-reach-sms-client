...
namespace Kanagama\ZettaiReachSmsClient\Tests\Unit\UseCase\CheckReservation\Request;
...
final class CheckReservationRequestTest extends TestCase
{
    /**
     * @return void
     */
    ...
    public function toArrayが正しく配列を返す(): void
    {
        ...
        $this->assertSame([
            ...
            'clientId' => '98765',
            'clientTag' => '12345678',
        ], $checkReservationRequest->toArray());
    }
}
