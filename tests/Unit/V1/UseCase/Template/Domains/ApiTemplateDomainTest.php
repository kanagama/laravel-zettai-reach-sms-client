...
use Kanagama\ZettaiReachSmsClient\V1\UseCase\Template\Domains\ApiTemplateDomain;
use Kanagama\ZettaiReachSmsClient\V1\UseCase\Template\Domains\ApiTemplateDomainInterface;
...
final class ApiTemplateDomainTest extends TestCase
{
    #[Test]
    #[Group('unit')]
    ...
    public function 処理を正しく実行できる(): void
    {
        ...
        /** @var ApiTemplateDomain */
        $apiTemplateDomain = app()->make(ApiTemplateDomainInterface::class);
        $response = $apiTemplateDomain->execute($templateRequestMock);
    }
}
