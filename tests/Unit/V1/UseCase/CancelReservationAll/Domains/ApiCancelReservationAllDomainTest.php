...
use Kanagama\ZettaiReachSmsClient\V1\UseCase\CancelReservationAll\Domains\ApiCancelReservationAllDomain;
use Kanagama\ZettaiReachSmsClient\V1\UseCase\CancelReservationAll\Domains\ApiCancelReservationAllDomainInterface;
...
final class ApiCancelReservationAllDomainTest extends TestCase
{
    #[Test]
    #[Group('unit')]
    ...
    public function 処理を正しく実行できる(): void
    {
        ...
        /** @var ApiCancelReservationAllDomain */
        $apiCancelReservationAllDomain = app()->make(ApiCancelReservationAllDomainInterface::class);
        $response = $apiCancelReservationAllDomain->execute($cancelReservationAllRequestMock);
    }
}
