...
use Kanagama\ZettaiReachSmsClient\V1\UseCase\ShortenUrl\Domains\ApiShortenUrlDomain;
use Kanagama\ZettaiReachSmsClient\V1\UseCase\ShortenUrl\Domains\ApiShortenUrlDomainInterface;
...
final class ApiShortenUrlDomainTest extends TestCase
{
    #[Test]
    #[Group('unit')]
    ...
    public function 処理を正しく実行できる(): void
    {
        ...
        /** @var ApiShortenUrlDomain */
        $apiShortenUrlDomain = app()->make(ApiShortenUrlDomainInterface::class);
        $response = $apiShortenUrlDomain->execute($shortenUrlRequestMock);
    }
}
