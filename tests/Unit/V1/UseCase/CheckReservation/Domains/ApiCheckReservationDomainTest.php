...
use Kanagama\ZettaiReachSmsClient\V1\UseCase\CheckReservation\Domains\ApiCheckReservationDomain;
use Kanagama\ZettaiReachSmsClient\V1\UseCase\CheckReservation\Domains\ApiCheckReservationDomainInterface;
...
final class ApiCheckReservationDomainTest extends TestCase
{
    #[Test]
    #[Group('unit')]
    ...
    public function 処理を正しく実行できる(): void
    {
        ...
        /** @var ApiCheckReservationDomain */
        $apiCheckReservationDomain = app()->make(ApiCheckReservationDomainInterface::class);
        $response = $apiCheckReservationDomain->execute($checkReservationRequestMock);
    }
}
