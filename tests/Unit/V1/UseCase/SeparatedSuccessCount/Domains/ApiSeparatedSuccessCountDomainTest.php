...
use Kanagama\ZettaiReachSmsClient\V1\UseCase\SeparatedSuccessCount\Domains\ApiSeparatedSuccessCountDomain;
use Kanagama\ZettaiReachSmsClient\V1\UseCase\SeparatedSuccessCount\Domains\ApiSeparatedSuccessCountDomainInterface;
...
final class ApiSeparatedSuccessCountDomainTest extends TestCase
{
    #[Test]
    #[Group('unit')]
    ...
    public function 処理を正しく実行できる(): void
    {
        ...
        /** @var ApiSeparatedSuccessCountDomain */
        $apiSeparatedSuccessCountDomain = app()->make(ApiSeparatedSuccessCountDomainInterface::class);
        $response = $apiSeparatedSuccessCountDomain->execute($separatedSuccessCountRequestMock);
    }
}
