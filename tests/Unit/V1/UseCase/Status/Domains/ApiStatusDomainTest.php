...
use Kanagama\ZettaiReachSmsClient\V1\UseCase\Status\Domains\ApiStatusDomain;
use Kanagama\ZettaiReachSmsClient\V1\UseCase\Status\Domains\ApiStatusDomainInterface;
...
final class ApiStatusDomainTest extends TestCase
{
    #[Test]
    #[Group('unit')]
    #[Group('StatusDomain')]
    ...
    public function 処理を正しく実行できる(): void
    {
        ...
        /** @var ApiStatusDomain */
        $apiStatusDomain = app()->make(ApiStatusDomainInterface::class);
        $response = $apiStatusDomain->execute($statusRequestMock);
    }
}
